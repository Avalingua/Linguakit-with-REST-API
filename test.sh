...
echo "\n"
curl -X POST -H "Content-Type: application/x-www-form-urlencoded; charset=utf-8" -d "lang=gl&output=nec&text=Rosalía xoga en Lugo con Feijoo, mentres na ONU debaten o futuro da Turkía de Erdogan."  $HOST/tagger
echo "\n"
